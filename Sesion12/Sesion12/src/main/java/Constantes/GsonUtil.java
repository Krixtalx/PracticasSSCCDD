 ...
 */
/**
 * Clase que nos proporciona la utilidad para codificar un objeto de tipo T a su
 * objeto String en formato JSON y la utilidad inversa
 *
 * @author pedroj
 * @param <T>
 */
public class GsonUtil<T> {
    ...
    /**
     * Método que nos permite trasnformar un objeto de tipo T a un String en su
     * formato JSON
     *
